...
const ContactCard: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const requestBody = {
        From: formData.email,  // Assuming you're using the email field for the recipient
      ...
      const response = await fetch('http://localhost:5190/api/emails/send', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="inline-flex flex-col w-full max-w-lg max-h-[40%] overflow-auto bg-slate-200 rounded-lg p-4 shadow-lg">
